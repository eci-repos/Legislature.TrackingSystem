...
/// <summary>
/// Interim in-memory persistence adapter for demographic data by session.
/// </summary>
internal sealed class InMemoryDemographicDataRepository : IDemographicDataRepository
{
    ...
    {
        IReadOnlyList<string> result = _data.Values
            .Select(d => d.Session)
